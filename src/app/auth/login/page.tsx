    ...
    <div className="min-h-[70vh] flex items-center justify-center px-4 py-16" style={{ backgroundColor: '#F4F2EF' }}>
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold mb-1" style={{ color: '#0F0F0F' }}>Welcome Back</h1>
          <p className="text-sm" style={{ color: '#6B7280' }}>Sign in to your PrintOrbit account</p>
        </div>
        ...
        <div className="bg-white p-6" style={{ border: '1px solid #E5E7EB' }}>
          <form className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 text-sm cursor-pointer" style={{ color: '#4B5563' }}>
                <input type="checkbox" className="rounded" style={{ accentColor: '#ED1C24' }} />
                Remember me
              </label>
              <a href="#" className="text-sm" style={{ color: '#ED1C24' }}>
                Forgot password?
              </a>
            </div>
            ...
            <button
              type="button"
              className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border rounded text-sm font-medium"
          ...
          <div className="mt-4 text-center">
            <p className="text-sm" style={{ color: '#6B7280' }}>
              ...
              <a href="#" className="font-semibold" style={{ color: '#ED1C24' }}>
                Sign In using OTP
              </a>
            </p>
          </div>
